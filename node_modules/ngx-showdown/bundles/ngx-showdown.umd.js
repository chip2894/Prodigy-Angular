(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/platform-browser'),require('@angular/common/http'),exports, require('@angular/core'), require('showdown'), require('@angular/platform-browser'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('ngx-showdown', ['@angular/core','@angular/platform-browser','@angular/common/http','exports', '@angular/core', 'showdown', '@angular/platform-browser', '@angular/common/http'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.platformBrowser,global.ng.common.http,global['ngx-showdown'] = {}, global.ng.core, global.showdown, global.ng.platformBrowser, global.ng.common.http));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, core, Showdown, platformBrowser, http) { 
var _c0 = ["*"];
'use strict';
...
var ɵShowdownPipe_BaseFactory = /*@__PURE__*/ ɵngcc0.ɵɵgetInheritedFactory(ShowdownPipe);
